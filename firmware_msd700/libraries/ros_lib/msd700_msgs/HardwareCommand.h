#ifndef _ROS_msd700_msgs_HardwareCommand_h
#define _ROS_msd700_msgs_HardwareCommand_h
...
namespace msd700_msgs
{
  ...
  class HardwareCommand : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "msd700_msgs/HardwareCommand"; };
